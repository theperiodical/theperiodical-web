...
export  function Footer(){
    return(
        <div id="subscribe" className="flex flex-col bg-primary-light w-full mt-28">
        <div className="flex flex-row items-center pt-8 px-8 justify-between ">
            <div className="flex flex-col w-full">
                <div className="flex flex-row w-full justify-between px-8  items-center">
                    ...
                    <Link href={'#gists'} className="text-center text-sm">Gists</Link>
                    <Link href={'#about-us'} className="text-center text-sm">About Us</Link>
                    <Link href={'#contact-us'} className="text-center text-sm">Contact Us</Link>
                    </div>
                </div>
                <div className="flex flex-row items-center justify-between mt-10 py-14 mx-8 px-24 bg-[#E8EFCF]">
                    ...
                    <button className="w-32 h-10 bg-primary-dark text-white text-sm hover:bg-primary-hover">Subscribe</button>
                    </div>
                </div>
